...
function referenceLookup(templateName) {
  const reference = {
    ...
    'liquid-async-dynamic-snippet': 'liquid-async-snippet',
    'liquid-global-dynamic-section': 'liquid-global-section',
    'liquid-global-dynamic-snippet': 'liquid-global-snippet',
    'liquid-web-dynamic-block': 'liquid-web-block',
    'liquid-web-dynamic-section': 'liquid-web-section',
    'liquid-web-dynamic-snippet': 'liquid-web-snippet',
    'liquid-web-limited-block': 'liquid-web-block',
    'liquid-web-limited-section': 'liquid-web-section',
