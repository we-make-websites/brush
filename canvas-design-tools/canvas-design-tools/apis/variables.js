...
function buildStyles(variables, stylesheet) {
  ...
  if (stylesheet.type === 'spacing') {
    // content += getSpacingTemplate(variables, stylesheet)
  } else {
...
/**
 * Generates spacing helper stylesheet.
 * @param {Object} variables - Converted variables object.
 * @param {Object} stylesheet - Stylesheet object.
 * @returns {String}
 */
/* function getSpacingTemplate(variables, stylesheet) {
  return ''
} */
